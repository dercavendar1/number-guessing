...
if (generated_number >= math.floor(((max_num - min_num) + min_num) / 2)):
    print(
        f'the number is between {math.floor(((max_num-min_num)+min_num) / 2)} and {max_num}')
else:
    print(
        f'the number is between {min_num} and {math.floor(((max_num-min_num)+min_num) / 2)}')
